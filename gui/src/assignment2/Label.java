...
public class Label extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(btnAdd)) {
			if (rdJuice.isSelected() || rdTea.isSelected() || rdCoffee.isSelected()
					|| rdWater.isSelected() && !(txtGlass.getText().isEmpty())) {
				try {
				...
				} catch (NumberFormatException e1) {// if written data in TextField can't be converted to an
													// integer[String,char,double etc...]
